...
path_feature = os.path.abspath('E:/extracted_embeddings_pretrained_concat')
...
def train_model():
    ...
    trainloader = DataLoader(train_dataset, batch_size=1, shuffle=False, pin_memory=True)
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        for data in trainloader:
            # Forward pass
            if data['data'].squeeze(0).shape[0] > 1000:
                continue
